...
; b,c,d - byte; a - word; e - double word; x - qword; - Signed representation
; (a * 2 + b / 2 + e) / (c - d) + x / a
...
start:
    ...
    mov eax, ebx ;eax = ebx = a*2 + b/2 + e
    cdq ;converting eax to edx:eax
    
    pop ebx
    idiv ebx ;eax = edx:eax / ebx, edc = edx:eax % ebx ;eax=(s*2+b/2+e)/(c-d)
    ...
    idiv esp ;eax = edx:eax / esp, edc = edx:eax % esp ;eax=x/a
