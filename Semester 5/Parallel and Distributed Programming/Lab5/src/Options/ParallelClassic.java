...
public class ParallelClassic {
    ...
    public static Polynomial multiply(Polynomial p1, Polynomial p2) throws InterruptedException {
        ...
        // initializes result polynomial w/ 0
        ...
        int nrOfTasks = sizeOfResultCoefficientList / NR_THREADS;  // how many coefficient per thread
        if (nrOfTasks == 0) {
            nrOfTasks = 1;
        }

        int end;  // end index of the coefficient range for each task
